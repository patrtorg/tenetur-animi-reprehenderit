# @patrtorg/tenetur-animi-reprehenderit
...
```js
import { jack } from '@patrtorg/tenetur-animi-reprehenderit'
// this works too:
// const { jack } = require('@patrtorg/tenetur-animi-reprehenderit')
...
folder](https://github.com/patrtorg/tenetur-animi-reprehenderit/tree/master/examples)
...
const j = jack({
  ...
  // if you want a number, say so, and @patrtorg/tenetur-animi-reprehenderit will enforce it
  .num({
    jobs: {
      short: 'j',
